...
import { CalendarDays, CheckCircle2, Cloud, ShieldCheck } from 'lucide-react';

const benefits = [
  'Get your account ready before the Pro rollout lands',
  'Keep Free local mode available whenever you do not need sync',
  'See privacy-cloud backup and restore as soon as it launches',
];
          ...
          <div className="relative mx-auto flex h-full max-w-xl flex-col justify-between">
            <div>
              ...
              <h1 className="mt-6 text-4xl font-bold tracking-tight md:text-5xl">
                Sign in if you want your account ready for the Pro rollout.
              </h1>
              <p className="mt-5 max-w-lg text-lg leading-relaxed text-muted-foreground">
                Caldy works without an account in Free local mode today. Sign in if you want an
                account ready for privacy-cloud backup, sync, restore, and billing once Pro opens.
              </p>

              <div className="mt-10 rounded-[2rem] border bg-card/75 p-6 shadow-sm backdrop-blur">
                <div className="mb-4 flex items-center gap-2 text-sm font-medium">
                  <Cloud className="h-4 w-4 text-primary" />
                  What signing in prepares
                </div>
            ...
            <div className="mt-12 text-sm text-muted-foreground">
              Prefer the free local experience first?{' '}
              <Link
                href="/dashboard"
